...
# USER PARAMETERS
resqml_file = '/full/filbane/til/modell.epc'
grid_name = 'navn_paa_grid_i_rms'
package_folder = '/path/to/tqdm_and_h5py/holder'
# ---------------
...
if platform.system() == 'Windows':
    ...
    try:
        ...
        sys.path.pop()
        sys.path.append(os.path.join(prefix, 'h5py-2.10.0-cp36-cp36m-win_amd64'))
else:
    sys.path.append(os.path.join(prefix, 'h5py-2.10.0-cp36-cp36m-manylinux1_x86_64'))
sys.path.append(os.path.join(prefix, 'tqdm-4.44.1-py2.py3-none-any'))  # In case it is not available yet
import tqdm
import h5py
